...
var process_options = function(proxy_options) {
  ...
  if(!options.verbose === false)     options.verbose          = options.verbose;
...
module.exports = function(proxy_options, processor_class) {
  ...
  var mitm_server = that.mitm_server = https.createServer(https_opts, function (request, response) {
  ...
  var server = that.server = http.createServer(function(request, response) {
