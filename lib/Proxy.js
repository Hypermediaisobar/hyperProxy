...
function Proxy(options) {
	...
	this.httpServer.addListener('connect', function(request, socket, head){
		// Assume that CONNECT is called for HTTPS if there is x-forwarded-proto header with https value or there is protocol specified in reuqest.url and it is not http.
